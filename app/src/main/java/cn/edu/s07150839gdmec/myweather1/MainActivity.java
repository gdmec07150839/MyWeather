package cn.edu.s07150839gdmec.myweather1;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refreshBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //请求天气信息
                new cn.edu.s07150839gdmec.myweather1.GetWeatherInfoTask(seft).execute(cityName);
            }
        });
        new cn.edu.s07150839gdmec.myweather1.GetWeatherInfoTask(this).execute("广州");
    }
    //初始化城市窗口
    ...
    private class ChooseCityListenner implements DialogInterface.OnClickListener{
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            //连接网络选取选中城市的天气
            new cn.edu.s07150839gdmec.myweather1.GetWeatherInfoTask(seft).execute(city_name);
        }
    }

    private void initProvinces() {
        AssetManager assetManager=getAssets();
        cn.edu.s07150839gdmec.myweather1.SaxHandler handler=new cn.edu.s07150839gdmec.myweather1.SaxHandler();
